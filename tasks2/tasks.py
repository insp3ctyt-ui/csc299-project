...
def add_task(task_description):
    ...
    new_task = {
        ...
        'status': 'pending'  # New field: 'pending' or 'completed'
    }
...
def list_tasks():
    ...
    print("--- Your Tasks ---")
    for task in tasks:
        # Use .get() for backward compatibility with tasks1.json files
...
def print_usage():
    ...
    print("  python tasks.py done <id>         - Marks a task as complete")
    print("  python tasks.py delete <id>       - Deletes a task")
